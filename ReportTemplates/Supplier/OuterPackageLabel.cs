...
namespace RuiguCrmReports.Supplier
{
    ...
    /// </summary>
    public partial class OuterPackageLabel : Telerik.Reporting.Report
    {
        public OuterPackageLabel()
        {
            //
        ...
        public void SetDataSource(object listDataSource)
        {
            ObjectDataSource objectDataSource = new ObjectDataSource();
            objectDataSource.DataSource = listDataSource;
        ...
        public void FitProductNameFontSize(int productLength)
        {
            ...
            else txtProductName.Style.Font.Size = new Unit(6, UnitType.Point);
        ...
        public void FitProductSpecFontSize(int stringLength)
        {
            ...
            else txtSpec.Style.Font.Size = new Unit(5, UnitType.Point);
        }
